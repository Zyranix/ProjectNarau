...
public class BeatmapHandler : MonoBehaviour
{
    ...
    void Start()
    {
        DirectoryInfo dir = new DirectoryInfo("Assets/Beatmaps/");
    ...
    public void SaveData(string location, Beatmap toSave)
    {
        ...
        FileStream saveFile = File.Create("Assets/Beatmaps/" + location + "/" + location + ".dat");
    ...
    {
        BinaryFormatter formatter = new BinaryFormatter();
        FileStream saveFile = File.Open("Assets/Beatmaps/" + location + "/" + location + ".dat", FileMode.Open);
